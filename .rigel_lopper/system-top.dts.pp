# 0 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/zynq-7000.dtsi" 1
# 10 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/system-top.dts" 2
# 1 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "LCD_base_wrapper.bit.bin";
  clocking0: clocking0 {
...
# 4 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/system-top.dts" 2
# 1 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &spi0 {
  ...
  xlnx,has-ss1 = <1>;
  num-cs = <3>;
  xlnx,spi-clk-freq-hz = <200000000>;
  xlnx,has-ss2 = <1>;
  xlnx,name = "ps7_spi_0";
 };
 &mc {
...
# 5 "/home/marti/Vitis_workspace/LCD_display/LCD_platform/hw/sdt/system-top.dts" 2
/ {
 device_id = "7z020";
 slrcount = <1>;
 family = "Zynq";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x41220000 &axi_gpio_2 0x41220000 0x10000>,
